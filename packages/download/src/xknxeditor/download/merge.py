...
def _default_procedure(
    ...
    ProcedureSubType (ap1/all/grp/par/par,grp). The reference stack picks a subtype-specific
    ...
    targets (see :mod:`xknxeditor.download.scope`). That object-based filtering was
